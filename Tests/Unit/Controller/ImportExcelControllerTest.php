...
/**
 * Test case for class Tx_Import_excel_Controller_ImportExcelController.
 *
 * @version $Id$
 ...
 */
class Tx_Import_excel_Controller_ImportExcelControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
